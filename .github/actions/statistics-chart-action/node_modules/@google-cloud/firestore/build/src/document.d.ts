 ...
 * @private
 */
export declare class DocumentSnapshotBuilder {
...
export declare class DocumentSnapshot {
     ...
     */
    constructor(ref: DocumentReference, fieldsProto?: ApiMapValue, readTime?: Timestamp, createTime?: Timestamp, updateTime?: Timestamp);
    /**
     ...
     */
    static fromObject(ref: DocumentReference, obj: DocumentData): DocumentSnapshot;
    /**
     ...
     * @return The created DocumentSnapshot.
     */
    static fromUpdateMap(ref: DocumentReference, data: UpdateMap): DocumentSnapshot;
    /**
 ...
 */
export declare class QueryDocumentSnapshot extends DocumentSnapshot {
    /**
     * @hideconstructor
     *
     * @param ref The reference to the document.
...
export declare class DocumentTransform {
     ...
     */
    constructor(ref: DocumentReference, transforms: Map<FieldPath, FieldTransform>);
    /**
     ...
     */
    static fromObject(ref: DocumentReference, obj: DocumentData): DocumentTransform;
    /**
     ...
     * @returns The Document Transform.
     */
    static fromUpdateMap(ref: DocumentReference, data: UpdateMap): DocumentTransform;
    /**
