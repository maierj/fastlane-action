...
export declare class Transaction {
     ...
     * being retried.
     */
    constructor(firestore: Firestore, requestTag: string, previousTransaction?: Transaction);
    /**
     ...
     * });
     */
    update(documentRef: DocumentReference, dataOrField: UpdateData | string | FieldPath, ...preconditionOrValues: Array<Precondition | unknown | string | FieldPath>): Transaction;
    /**
     ...
     * });
     */
    delete(documentRef: DocumentReference, precondition?: PublicPrecondition): this;
    /**
 ...
 */
export declare function parseGetAllArguments(documentRefsOrReadOptions: Array<DocumentReference | ReadOptions>): {
