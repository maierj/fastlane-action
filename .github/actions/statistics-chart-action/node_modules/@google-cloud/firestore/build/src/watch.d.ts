 ...
 */
declare type DocumentComparator = (l: QueryDocumentSnapshot, r: QueryDocumentSnapshot) => number;
/**
...
declare abstract class Watch {
     ...
     * listener.
     */
    onSnapshot(onNext: (readTime: Timestamp, size: number, docs: () => QueryDocumentSnapshot[], changes: () => DocumentChange[]) => void, onError: (error: Error) => void): () => void;
    /**
 ...
 * @private
 */
export declare class DocumentWatch extends Watch {
    private readonly ref;
    constructor(firestore: Firestore, ref: DocumentReference);
 ...
 * @private
 */
export declare class QueryWatch extends Watch {
