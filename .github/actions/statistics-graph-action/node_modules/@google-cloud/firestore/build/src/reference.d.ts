 ...
 * @class
 */
export declare class DocumentReference implements Serializable {
     ...
     */
    constructor(_firestore: Firestore, _path: ResourcePath);
    /**
...
export declare class QuerySnapshot {
     ...
     */
    constructor(_query: Query, _readTime: Timestamp, _size: number, docs: () => QueryDocumentSnapshot[], changes: () => DocumentChange[]);
    /**
...
export declare class QueryOptions {
    ...
    constructor(parentPath: ResourcePath, collectionId: string, allDescendants: boolean, fieldFilters: FieldFilter[], fieldOrders: FieldOrder[], startAt?: QueryCursor | undefined, endAt?: QueryCursor | undefined, limit?: number | undefined, offset?: number | undefined, projection?: api.StructuredQuery.IProjection | undefined);
    /**
    ...
    isEqual(other: QueryOptions): any;
}
/**
...
export declare class Query {
     ...
     */
    constructor(_firestore: Firestore, _queryOptions: QueryOptions);
    /**
     ...
     */
    static _isDocumentSnapshot(fieldValuesOrDocumentSnapshot: Array<DocumentSnapshot | unknown>): boolean;
    /**
     ...
     * });
     */
    startAt(...fieldValuesOrDocumentSnapshot: Array<DocumentSnapshot | unknown>): Query;
    /**
     ...
     * });
     */
    startAfter(...fieldValuesOrDocumentSnapshot: Array<DocumentSnapshot | unknown>): Query;
    /**
     ...
     * });
     */
    endBefore(...fieldValuesOrDocumentSnapshot: Array<DocumentSnapshot | unknown>): Query;
    /**
     ...
     * });
     */
    endAt(...fieldValuesOrDocumentSnapshot: Array<DocumentSnapshot | unknown>): Query;
    /**
