...
[![@latest](https://img.shields.io/npm/v/@octokit-next/request.svg)](https://www.npmjs.com/package/@octokit-next/request)
[![Build Status](https://github.com/octokit-next/request.js/workflows/Test/badge.svg)](https://github.com/octokit-next/request.js/actions?query=workflow%3ATest+branch%3Amaster)

`@octokit-next/request` is a request library for modern JavaScript runtime environments (e.g. Browsers, Node, or Deno) that makes it easier
...
👶 [Small bundle size](https://bundlephobia.com/result?p=@octokit-next/request) (\<4kb minified + gzipped)
...
Load <code>@octokit-next/request</code> directly from <a href="https://cdn.skypack.dev">cdn.skypack.dev</a>
...
Install with <code>npm install @octokit-next/request</code>
...
For GraphQL request we recommend using [`@octokit/graphql`](https://github.com/octokit/graphql.js#readme). But in the end a GraphQL query is just a `POST /graphql` request:
...
For more complex authentication strategies such as GitHub Apps, we recommend an [authentication strategy plugin](https://github.com/octokit/authentication-strategies.js#readme).
...
<table>
  ...
  <tr>
    ...
    <td>
      Name of GraphQL schema preview, e.g. `package-deletes` or `flash`. See <a href="https://docs.github.com/en/graphql/overview/schema-previews">Schema previews</a>.
    </td>
  </tr>
  <tr>
    <th align=left>
